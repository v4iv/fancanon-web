...
<div class="min-h-screen">
  <div class="border-b">
    <header class="mx-auto w-full max-w-screen-lg space-y-3 px-3 py-10">
      ...
      <p class="text-md md:text-md">{data.frontmatter.subtitle}</p>
    </header>
  </div>

  <div class="mx-auto flex max-w-screen-lg items-center justify-center px-3 py-20">
    <Stepper.Root step={data.frontmatter.step}>
      <Stepper.Nav orientation="vertical" class="w-full px-4">
        {#each data.frontmatter.steps as item, idx (idx)}
          <Stepper.Item>
