export default function resetPasswordTemplate(url: string) {
  return `
        <!DOCTYPE html>
        <html>
          <head>
            <meta charset="UTF-8" />
            <title>Reset Your Password — fancanon</title>
          </head>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 12px rgba(4, 47, 46, 0.08); overflow: hidden;">
                    ...
                    <tr>
                      <td style="padding: 40px;">
                        <h2 style="margin-top: 0; color: #042f2e; font-size: 20px;">Reset Your Password</h2>
                        <p style="color: #115e59; font-size: 16px; line-height: 1.5;">
                          You recently requested to reset your password for your <span style="font-weight: 100;">fancanon</span> account. Click the button below to reset it.
                        </p>
                        <p style="margin: 30px 0; text-align: center;">
                          <a href="${url}" style="background-color: #0d9488; color: #f0fdfa; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-block;">
                            Reset Password
                          </a>
                        </p>
