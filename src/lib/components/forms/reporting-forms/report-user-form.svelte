<script lang="ts">
  ...
  import { reportUser } from '$lib/remote/reporting/data.remote'
  import { track } from '$lib/analytics'
  import { USER_REASONS } from '$lib/constants'
  import * as Field from '$lib/components/ui/field'
  import * as RadioGroup from '$lib/components/ui/radio-group'
  import { Button } from '$lib/components/ui/button'
  import { Textarea } from '$lib/components/ui/textarea'
  import { reportUserSchema } from '$lib/components/forms/reporting-forms'
  ...
  const { userId, onOpenChange }: Props = $props()

  let form = $derived(reportUser)
  ...
  <Field.Group>
    ...
    <Field.Set>
      ...
      <RadioGroup.Root bind:value={reason} disabled={submitting} required>
        {#each USER_REASONS as option, idx (idx)}
